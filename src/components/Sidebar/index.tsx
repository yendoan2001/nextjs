...
const Sidebar = ({sidebarOpen, setSidebarOpen}: SidebarProps) => {
    ...
    return (
        <aside
            ref={sidebar}
            className={`absolute left-0 top-0 z-9999 flex h-screen w-62.5 flex-col overflow-y-hidden shadow-md bg-white duration-300 ease-linear lg:static lg:translate-x-0 ${
                    ...
                    <div>
                        <ul className="mb-6 flex flex-col gap-2">
                            ...
                            <li className='px-2'>
                                <Link
                                    href="/home"
                                    className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-3 font-medium text-black duration-300 hover:bg-gradient-to-r from-[#76DCFF] to-[#FF89E7] hover:rounded-xl hover:text-white dark:hover:bg-meta-4${
