...
const ValidatePhoneOTPOldForm = () => {
  const { setStep } = useStepperStore();
  return (
    <form className="w-full">
      <h2 className="text-color-gray-sm mt-8 text-center">
        Một mã OTP vừa được gửi đến{" "}
        <span className="font-semibold text-[#1B2837]">số điện thoại cũ</span>{" "}
        của bạn để xác thực thay đổi: <br />
...
export default ValidatePhoneOTPOldForm;
